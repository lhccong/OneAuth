...
import com.cong.oauth.utils.StringUtils;
...
public class AuthConfig {
     ...
     * <p>
     * Coding 登录：团队域名前缀，比如以“ <a href="https://justauth.coding.net">...</a> ”为例，{@code domainPrefix} = justauth
     * <p>
     * Okta 登录：Okta 账号域名前缀，比如以“ <a href="https://justauth.okta.com">...</a> ”为例，{@code domainPrefix} = justauth
     *
     * @since 1.16.0
     */
     ...
     * {@link com.cong.oauth.request.core.AuthDefaultRequest#login(AuthCallback)} 将不会校验 {@code state} 的合法性。
     * <p>
     ...
     * 创建自定义授权服务器，请参考：
     * <p>
     * ① <a href="https://developer.okta.com/docs/concepts/auth-servers">StringUtils</a>
     * <p>
     ...
     * {@link com.cong.oauth.utils.AuthChecker#checkConfig(AuthConfig, AuthSource)} 将不会校验 {@code redirectUri} 的合法性。
     *
     * @since 1.16.1
     */
